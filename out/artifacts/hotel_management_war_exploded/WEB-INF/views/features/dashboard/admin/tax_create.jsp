...
<html>
    <head>
        ...
        <title>Create Tax Configuration</title>
        <style>
            :root {
    ...
    <body>
        ...
        <div class="form-container">
            <form method="post" action="${pageContext.request.contextPath}/admin/tax/create">
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description"
                              placeholder="Optional description of this tax configuration"></textarea>
                </div>
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-primary">Create Tax Configuration</button>
